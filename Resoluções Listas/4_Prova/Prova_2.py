            ...
            if (numberOfTips > 0):
                ...
                if (tipNumber > sortedNumber):
                    ...
                    if (tipNumber < sortedNumber):
                        ...
                        #Momento engraçado onde o usuário digitou o número sorteado na hora de pedir dica
                        print("Eita... Não vou dar a dica.");
            else:
